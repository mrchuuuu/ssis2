...
def new_course_window():
    ...
    add_course = ttk.Button(course_window, bootstyle=(SUCCESS, OUTLINE), text="Add Course", width=20, command=add_command)
...
new_course = ttk.Button(course_buttons, width=20, bootstyle=(PRIMARY, OUTLINE), text="New Course", command=new_course_window)
...
edit_course = ttk.Button(course_buttons, width=20, bootstyle=(INFO, OUTLINE), text="Edit Course", command=edit_course_command)
...
def course_delete_button():
    ...
    delete_label = ttk.Label(course_window, text=f"Are you sure you want to delete {course_code}?", bootstyle=DANGER)
    delete_label.pack(side=TOP)
    delete_course = ttk.Button(course_window, bootstyle=(SUCCESS, OUTLINE), text="Yes", width=20, command=delete_command)
    delete_course.pack(side=LEFT, padx=10, pady=10)
    cancel = ttk.Button(course_window, bootstyle=(DANGER, OUTLINE), text="Cancel", width=20, command=course_window.destroy)
    cancel.pack(side=LEFT, padx=10, pady=10)
    
    
delete_course = ttk.Button(course_buttons, width=20, bootstyle=(DANGER, OUTLINE), text="Delete Course", command=course_delete_button)
...
def new_student():
    ...
    def add_student_command():
        ...
        if not len(course):
            course = "N/A"
        cursor.execute("INSERT INTO students (id, name, gender, year, course) VALUES (?, ?, ?, ?, ?)", (id, name, gender, year_level, course))
        connection.commit()
...
new_student_button = ttk.Button(student_buttons, text="New Student", width=20, bootstyle=(SUCCESS, OUTLINE), command=new_student)
...
def student_delete_button():
    ...
    delete_label = ttk.Label(student_window, text=f"Are you sure you want to delete '{id}'?", bootstyle=DANGER)
    delete_label.pack(side=TOP)
    delete_course = ttk.Button(student_window, bootstyle=(SUCCESS, OUTLINE), text="Yes", width=20, command=delete_command)
    delete_course.pack(side=LEFT, padx=10, pady=10)
    cancel = ttk.Button(student_window, bootstyle=(DANGER, OUTLINE), text="Cancel", width=20, command=student_window.destroy)
    cancel.pack(side=LEFT, padx=10, pady=10)
    
delete_student_button = ttk.Button(student_buttons, text="Delete Student", width=20, bootstyle=(DANGER, OUTLINE), command=student_delete_button)
